...
const SearchMoviePoster = () => {
  ...
  const genreMapper = (id) => {
    const genres = {
      28: "Action",
      18: "Drama",
      53: "Thriller",
      // Add more genre mappings as required
    };
  ...
  return (
    <div className="absolute top-[30%] z-30 container mx-auto px-4">
      ...
      <div className="scrol h-[410px] lg:h-[460px] overflow-y-auto">
            ...
            {/* Title */}
              ...
              <div className="mb-4">
                ...
                {selectedMovie.genre_ids
                  .map((id) => genreMapper(id)) // genreMapper is a function to map genre IDs to names
                  .join(", ")}
              </div>
