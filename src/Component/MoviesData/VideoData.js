...
const VideoData = ({ title, overview }) => {
  return (
    <div className="absolute bottom-20 left-12 max-w-4xl text-white">
      ...
      <p className="text-xl text-gray-300 mb-8 leading-relaxed drop-shadow-lg">
        {overview}
      </p>
      <div>
        ...
        <button className="ml-6 p-4 px-12 bg-gray-700 text-white text-xl font-semibold rounded-md shadow-lg hover:bg-gray-600 transition duration-300">
          More Info
        </button>
      </div>
    </div>
